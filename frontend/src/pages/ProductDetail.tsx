...
import { ArrowLeft, Share2, Star, MapPin, Clock, ShoppingCart, Check } from 'lucide-react';
        ...
        return (
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="text-center">
                    <p className="text-xl font-bold text-gray-900 mb-4">Product not found</p>
                    ...
                    <div className="px-4 py-6 md:p-8 space-y-6 relative -mt-6 md:mt-0 bg-white rounded-t-3xl md:rounded-none">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center gap-1 bg-green-50 px-3 py-1.5 rounded-xl border border-green-100">
                                ...
                                <span className="text-green-600/60 text-xs ml-1">(120+ reviews)</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                            <div className="flex justify-between items-center">
                                <span className="font-medium text-gray-900">Quantity (kg)</span>
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold text-gray-900">Product Highlights</h3>
                            <div className="grid grid-cols-2 gap-3 text-sm">
                                ...
                                <div className="flex items-center gap-3 p-3 bg-white border border-gray-100 rounded-xl shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500">Verified Farm</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        {/* Bottom Action Bar */}
                        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 md:static md:bg-transparent md:border-none md:p-0 z-40">
                            <div className="max-w-4xl mx-auto flex items-center gap-3">
                                ...
                                >
                                    {user?.role === 'buyer' ? 'Buy Now' : 'Login to Buy'}
                                </button>
                            </div>
                        </div>
                    </div>
